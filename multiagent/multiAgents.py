...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        """
        minimax = self.minimax(gameState, agentIndex=0, depth=0 )
        #print minimax['value']
        return minimax['action']
    
    def minimax(self, gameState, agentIndex, depth, action=Directions.STOP):
        print(depth) 
    ...
    def maxValue(self, gameState, agentIndex, depth):
        ...
        for action in legalMoves:
            ...
            successorMinMax = self.minimax(successorGameState, successor_index, successor_depth, action)
